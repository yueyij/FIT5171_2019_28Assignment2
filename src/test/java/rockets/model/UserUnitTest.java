...
public class UserUnitTest {
    ...
    @BeforeEach
    public void setUp() {
        target = new User("Yueyi","Zhao","abc@gmail.com","ThisIsAPassword");
    }
    ...
    public void shouldThrowExceptionWhenPassInvalidToUserConstructor() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> new User("YueyiYueyiYueyiYueyiYueyiYueyiYueyi","Zhao","abc@gmail.com","ThisIsAPassword"));
